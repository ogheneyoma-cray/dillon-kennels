...
export default function NewsletterForm() {
  ...
  if (submitted) {
    return (
      <p className="text-sm font-semibold text-sunbeam">
  ...
  return (
    ...
    >
      ...
      <button
        type="submit"
        className="inline-flex min-h-[48px] items-center justify-center rounded-full bg-sunbeam px-7 text-sm font-semibold text-dusk transition-colors hover:bg-sunbeam-dark hover:text-paper"
      >
        Subscribe
      </button>
    </form>
