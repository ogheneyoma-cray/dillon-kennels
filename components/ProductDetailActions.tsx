      ...
      <div className="flex items-center gap-4">
        ...
        <div className="flex items-center rounded-md border border-ink/15">
          <button
            ...
            className="flex h-11 w-11 items-center justify-center text-lg text-ink transition-colors hover:bg-mist disabled:opacity-30"
            disabled={quantity <= 1}
          >
            −
          </button>
          ...
          <button
            ...
            className="flex h-11 w-11 items-center justify-center text-lg text-ink transition-colors hover:bg-mist"
          >
            +
          </button>
        </div>
