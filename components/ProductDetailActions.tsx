      ...
      <div className="flex items-center gap-4">
        ...
        <div className="flex items-center border border-navy/20">
          <button
            ...
            className="flex h-11 w-11 items-center justify-center text-lg text-navy transition-colors hover:bg-cream disabled:opacity-30"
            disabled={quantity <= 1}
          >
            −
          </button>
          <span className="flex h-11 w-12 items-center justify-center border-x border-navy/20 text-sm font-bold">
            {quantity}
          </span>
          <button
            type="button"
            ...
            className="flex h-11 w-11 items-center justify-center text-lg text-navy transition-colors hover:bg-cream"
          >
            +
          </button>
        </div>
