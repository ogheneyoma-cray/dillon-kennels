    ...
    <div className="group relative flex flex-col">
      ...
      >
        ...
        {product.popular && product.inStock && (
          <span className="absolute left-3 top-3 bg-mustard px-3 py-1 text-[10px] font-bold uppercase tracking-wide text-paper">
            Bestseller
          </span>
        )}
      ...
      <div className="mt-4 flex flex-1 flex-col">
        <Link href={`/shop/${product.slug}`}>
          <h3 className="font-display text-xl uppercase leading-tight tracking-tight text-ink transition-colors group-hover:text-spruce">
            {product.name}
          </h3>
        </Link>
