...
export default function Header() {
  ...
  return (
    <header className="sticky top-0 z-50 border-b border-line bg-lavender/95 backdrop-blur">
      <div className="border-b border-ink/10 bg-ink py-2 text-center text-[11px] font-medium uppercase tracking-widest2 text-lavender">
        Instant access — new courses added every month
      </div>
