...
export default function Header() {
  ...
  return (
    <header className="sticky top-0 z-50">
      <div className="hidden bg-dusk text-paper/80 sm:block">
        <div className="container-page flex h-9 items-center justify-between text-xs">
          <span>Practical IT services, priced up front.</span>
        ...
        <div className="container-page flex h-20 items-center justify-between">
          ...
          <div className="flex items-center gap-3 sm:gap-4">
            ...
            >
              ...
              {cartCount > 0 && (
                <span className="absolute -right-1 -top-1 flex h-5 w-5 items-center justify-center rounded-full bg-signal text-[10px] font-bold text-paper">
