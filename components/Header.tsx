      ...
      <div className="container-page flex h-[72px] items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          ...
          <Link
            ...
            className="relative flex min-h-[44px] min-w-[44px] items-center justify-center rounded-xl bg-lavender transition-colors hover:bg-violet-pale"
          >
            <svg
              width="22"
              height="22"
            ...
            {cartCount > 0 && (
              <span className="absolute -right-1.5 -top-1.5 flex h-5 w-5 items-center justify-center rounded-full bg-violet font-display text-[10px] font-bold text-white">
          ...
          <div className="container-page flex flex-col py-2">
            {NAV_LINKS.map((link) => (
              <Link
                ...
                className="flex min-h-[48px] items-center rounded-lg px-3 font-display text-sm font-medium text-ink hover:bg-lavender"
              >
                {link.label}
              </Link>
            ))}
