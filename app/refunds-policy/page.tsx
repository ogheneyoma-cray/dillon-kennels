  ...
  return (
    <div className="container-page py-10 lg:py-16">
      ...
      <div className="mt-10 max-w-3xl space-y-8 text-ink/80">
        <section>
          <h2 className="font-display text-xl uppercase text-ink">Return Window</h2>
        ...
        <section>
          <h2 className="font-display text-xl uppercase text-ink">How to Start a Return</h2>
          <p className="mt-3 leading-relaxed">
        ...
        <section>
          <h2 className="font-display text-xl uppercase text-ink">Refund Processing</h2>
          <p className="mt-3 leading-relaxed">
        ...
        <section>
          <h2 className="font-display text-xl uppercase text-ink">Exchanges</h2>
          <p className="mt-3 leading-relaxed">
        ...
        <section>
          <h2 className="font-display text-xl uppercase text-ink">Damaged or Incorrect Items</h2>
          <p className="mt-3 leading-relaxed">
