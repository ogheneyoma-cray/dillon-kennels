...
export const metadata: Metadata = {
  title: "Refunds Policy | Nudgenic",
  description: "Returns, exchanges, and refund timelines for Nudgenic orders.",
};
      ...
      <div className="mx-auto mt-10 max-w-3xl space-y-8 text-ink/80">
        <section>
          ...
          <p className="mt-3 leading-relaxed">
            ...
            original tags attached. Earrings and other pierced jewelry are
            final sale for hygiene reasons.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="mt-3 leading-relaxed">
            Email csteam@nudgeinc.com with your order number and the reason
            for your return within 7 days of delivery. Our team will
            confirm eligibility and share instructions for returning the
            item to our Oyo Town base at Ile Alaso, Imale Falatori Area,
            Oyo West Local Government Area, Oyo State.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="mt-3 leading-relaxed">
            Need a different size or color? Let us know when you start your
            return and we'll prioritize shipping the replacement as soon as
            your returned item arrives, subject to availability. If your
