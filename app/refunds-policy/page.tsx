...
export const metadata: Metadata = {
  ...
  description: "Returns, exchanges, and refund timelines for Feteframe orders.",
};
      ...
      <div className="mt-10 max-w-3xl space-y-8 text-ink-soft">
        <section>
          ...
          <p className="mt-3 leading-relaxed">
            We accept returns and exchanges within 7 days of delivery. To be eligible, items must be unused,
            unopened, and returned in their original packaging. Items marked final sale are not eligible for
            return.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="mt-3 leading-relaxed">
            If you'd like a different item, indicate this when starting your return and we'll prioritize
            shipping the exchange once your returned item is received, subject to availability.
          </p>
        </section>
