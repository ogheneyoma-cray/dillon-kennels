...
export const metadata: Metadata = {
  ...
  description: "Cancellations and refund timelines for Echo E-Rom service bookings.",
};
      ...
      <div className="mt-10 max-w-3xl space-y-8 text-ink-soft">
        <section>
          ...
          <p className="mt-3 leading-relaxed">
            ...
            has begun, refunds are assessed case by case based on the
        ...
        <section>
          ...
          <p className="mt-3 leading-relaxed">
            ...
            your request within 7 days of booking. Our team will confirm
            your eligibility and, where approved, process the refund to
        ...
        <section>
          ...
          <p className="mt-3 leading-relaxed">
            ...
            work at no additional charge. If the issue still cannot be
            resolved, we will offer a partial or full refund depending on
            the circumstances.
          </p>
        </section>

        <section>
          <h2 className="font-display text-xl font-bold text-ink">Non-Refundable Services</h2>
          <p className="mt-3 leading-relaxed">
            Diagnostic work already performed, such as an initial data
            recovery assessment, is non-refundable once completed, even if
            you choose not to proceed with the full service afterward.
          </p>
        </section>
      </div>
    </div>
