...
export const metadata: Metadata = {
  ...
  description:
    "Get in touch with the Lawin Store team — address, phone, email, and business hours.",
};
          ...
          <div className="rounded-xl border border-line bg-paper p-6">
            ...
            <dl className="mt-5 space-y-4 text-sm text-ink/80">
              ...
              <div>
                ...
                <dd className="mt-1">
                  <a href={`mailto:${site.email}`} className="hover:text-berry">
                    {site.email}
                  </a>
                </dd>
              </div>
              <div>
                ...
                <dd className="mt-1">
                  <a href={`tel:${site.phoneHref}`} className="hover:text-berry">
                    {site.phone}
                  </a>
                </dd>
              </div>
