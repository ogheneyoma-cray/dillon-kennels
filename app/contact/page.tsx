...
export const metadata: Metadata = {
  ...
  description:
    "Get in touch with the zenpulse digital team — store address, phone, email, and business hours.",
};
...
const FAQS = [
  ...
  },
  {
    ...
    answer:
      "We accept refund requests within 7 days of purchase if a course hasn't met your expectations. Please visit our Refunds Policy page for the full process and eligibility details.",
  },
  {
