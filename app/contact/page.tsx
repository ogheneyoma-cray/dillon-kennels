...
export const metadata: Metadata = {
  ...
  description: "Get in touch with the Echo E-Rom team — email, phone, address and business hours.",
};
  ...
  return (
    <div className="container-page py-10 lg:py-16">
      ...
      <p className="mt-4 max-w-xl text-ink-soft">
        Have a question about a service, a booking, or just want to say
      ...
      <div className="mt-12 grid grid-cols-1 gap-12 lg:grid-cols-[1.2fr_1fr]">
        ...
        <aside className="space-y-6">
          <div className="rounded-2xl border border-line bg-white p-6 shadow-tile">
            ...
            <dl className="mt-5 space-y-4 text-sm text-ink-soft">
              ...
              <div>
                ...
                <dd className="mt-1">
                  <a href={`tel:${site.phoneHref}`} className="hover:text-cobalt">
                    {site.phone}
                  </a>
                </dd>
              </div>
          ...
          <div className="rounded-2xl bg-cobalt-pale p-6">
