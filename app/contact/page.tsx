...
export const metadata: Metadata = {
  ...
  description:
    "Get in touch with the Shams Light team — address, phone, email, and business hours.",
};
  ...
  return (
    <div className="container-page py-10 lg:py-16">
      ...
      <p className="mt-4 max-w-xl text-ink-soft">
        Have a question about an order, a service, or just want to say hello?
          ...
          <div className="rounded-2xl border border-line bg-paper p-6">
            ...
            <dl className="mt-5 space-y-4 text-sm text-ink/80">
              ...
              <div>
                ...
                <dd className="mt-1">
                  <a href={`tel:${site.phoneHref}`} className="hover:text-signal">
                    {site.phone}
                  </a>
                </dd>
              </div>
