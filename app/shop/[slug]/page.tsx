  ...
  return (
    <div className="container-page py-10 lg:py-16">
      <nav className="mb-8 text-xs uppercase tracking-wider text-ink-soft">
        <Link href="/" className="hover:text-aubergine">Home</Link>
        <span className="mx-2">/</span>
        <Link href="/shop" className="hover:text-aubergine">Shop</Link>
        <span className="mx-2">/</span>
        <span className="text-ink">{product.name}</span>
      </nav>

      <div className="grid grid-cols-1 gap-10 lg:grid-cols-2 lg:gap-16">
        <div className="relative aspect-[3/4] overflow-hidden rounded-sm bg-aubergine-pale">
          <Image
            src={product.image}
            alt={product.name}
            fill
        ...
        <div>
          ...
          <div className="mt-3 flex items-center gap-3">
            ...
            <ProductPrice priceUsd={product.price} className="font-body text-xl font-semibold text-aubergine" />
          </div>
          ...
          <dl className="mt-8 space-y-2 border-t border-line pt-6 text-sm text-ink-soft">
            <div className="flex justify-between">
              <dt>Availability</dt>
              <dd className={product.inStock ? "font-semibold text-aubergine" : "font-semibold text-peach-dark"}>
