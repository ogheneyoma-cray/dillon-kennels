  ...
  return (
    <div className="container-page py-10 lg:py-16">
      <nav className="mb-8 text-xs uppercase tracking-wider text-ink/50">
        ...
        <Link href="/shop" className="hover:text-teal-dark">
          Shop
        </Link>
        <span className="mx-2">/</span>
      ...
      <div className="grid grid-cols-1 gap-10 lg:grid-cols-2 lg:gap-16">
        <div className="relative mx-auto aspect-square w-full max-w-sm">
          <ProductImage product={product} className="shadow-lift" />
          {product.popular && (
            <span className="absolute right-4 top-4 rounded-full bg-amber px-3 py-1 text-[11px] font-bold uppercase tracking-widest2 text-ink">
              Popular
            </span>
          )}
        </div>
        ...
        <div>
          ...
          <p className="mt-2 text-sm text-ink/50">{product.techStack}</p>
          <ProductPrice
            priceUsd={product.price}
            className="mt-3 block text-xl font-bold text-teal-dark"
          />
          ...
          <dl className="mt-8 space-y-2 border-t border-ink/10 pt-6 text-sm text-ink/70">
            <div className="flex justify-between">
              <dt>Availability</dt>
              <dd className={product.inStock ? "text-teal-dark" : "text-amber-dark"}>
            ...
            <div className="flex justify-between gap-6 text-right">
              <dt className="shrink-0">Stack</dt>
              <dd>{product.techStack}</dd>
            </div>
            <div className="flex justify-between gap-6 text-right">
