  ...
  return (
    <div className="container-page py-10 lg:py-16">
      <nav className="mb-8 text-xs uppercase tracking-wider text-ink-soft">
        <Link href="/" className="hover:text-beacon">
          Home
        </Link>
        <span className="mx-2">/</span>
        <Link href="/shop" className="hover:text-beacon">
          Shop
        </Link>
        <span className="mx-2">/</span>
      ...
      <div className="grid grid-cols-1 gap-10 lg:grid-cols-[minmax(0,360px)_1fr] lg:gap-16">
        <div className="mx-auto w-full max-w-xs lg:max-w-none">
          <div className="relative aspect-[4/5] w-full overflow-hidden rounded-2xl bg-mist shadow-lift">
            <ProductCover
              src={product.image}
        ...
        <div>
          ...
          <ProductPrice
            ...
            className="mt-4 block text-xl font-semibold text-beacon"
          />
          ...
          <dl className="mt-8 space-y-2 border-t border-line pt-6 text-sm text-ink-soft">
            ...
            <div className="flex justify-between">
              <dt>Delivery</dt>
              <dd>Remote, scheduled after payment</dd>
            </div>
            <div className="flex justify-between">
              <dt>Format</dt>
              <dd>One-time engagement, no subscription</dd>
            </div>
          </dl>
        </div>
      </div>
