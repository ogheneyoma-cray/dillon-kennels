  ...
  return (
    <div className="container-page py-10 lg:py-16">
      ...
      <div className="grid grid-cols-1 gap-10 lg:grid-cols-2 lg:gap-16">
        <div className="relative mx-auto aspect-[4/5] w-full max-w-sm overflow-hidden bg-mist shadow-lift">
          <Image
            src={product.image}
            alt={product.name}
            fill
          ...
          />
          {product.popular && (
            <span className="absolute left-0 top-4 bg-orange px-3 py-1 text-[11px] font-bold uppercase tracking-widest2 text-white">
              Popular
            </span>
          )}
        </div>
        ...
        <div>
          ...
          <ProductPrice
            ...
            className="mt-3 block text-xl font-bold text-orange-dark"
          />
          ...
          <dl className="mt-8 space-y-2 border-t border-ink/10 pt-6 text-sm text-ink/70">
            <div className="flex justify-between">
              <dt>Availability</dt>
              <dd className={product.inStock ? "text-sage" : "text-orange-dark"}>
