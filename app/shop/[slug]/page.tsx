  ...
  return (
    <div className="container-page py-10 lg:py-16">
      <nav className="mb-8 text-xs font-semibold uppercase tracking-wider text-ink-soft">
        ...
        <Link href="/shop" className="hover:text-cobalt">
          Services
        </Link>
        <span className="mx-2">/</span>
      ...
      <div className="grid grid-cols-1 gap-10 lg:grid-cols-2 lg:gap-16">
        <div className="relative aspect-[16/11] overflow-hidden rounded-3xl bg-cobalt-pale">
          <Image
            src={product.image}
            alt={product.name}
            fill
        ...
        <div>
          ...
          <div className="mt-3 flex items-center gap-3">
            ...
            <ProductPrice
              ...
              className="font-display text-xl font-bold text-cobalt"
            />
          </div>
          ...
          <dl className="mt-8 space-y-2 border-t border-line pt-6 text-sm text-ink-soft">
            <div className="flex justify-between">
              <dt>Availability</dt>
              <dd className={product.inStock ? "font-semibold text-mint" : "font-semibold text-flare"}>
