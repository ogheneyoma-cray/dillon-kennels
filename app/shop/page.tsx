...
export const metadata: Metadata = {
  ...
  description: `Browse the full ${site.name} collection of men's shirts, t-shirts, jackets, sweaters and footwear.`,
};
    ...
    <div className="container-page py-12 lg:py-16">
      <div className="max-w-xl">
        ...
        <p className="mt-4 text-base leading-relaxed text-ink/70">
          Fifteen pieces built for everyday wear. Prices shown convert
      ...
      <div className="mt-8 flex flex-wrap gap-2">
        <Link
          ...
          className={`border px-4 py-2 text-xs font-bold uppercase tracking-wide transition-colors ${
            !isValidCategory
              ? "border-spruce bg-spruce text-paper"
              : "border-ink/20 text-ink/70 hover:border-spruce hover:text-spruce"
          }`}
        >
          All
        </Link>
