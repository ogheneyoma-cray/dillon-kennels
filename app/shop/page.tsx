...
export const metadata: Metadata = {
  title: "Shop | Vergemind",
  description:
    "Shop the full Vergemind collection of men's tees, shirts, outerwear, denim, knitwear, footwear, and accessories.",
};
    ...
    <div className="container-page py-12 lg:py-16">
      <div className="flex flex-col items-center text-center">
        ...
        <p className="mt-4 max-w-xl text-sm leading-relaxed text-bone/70">
          Fifty pieces across tees, shirts, outerwear, denim, knitwear,
          footwear, and accessories — every one built for daily rotation,
          not just the drop day.
        </p>
      </div>
      ...
      <p className="mt-6 text-center text-xs uppercase tracking-widest2 text-muted">
