...
export const metadata: Metadata = {
  ...
  description:
    "Every product Ticad Iboo offers, from kitchen essentials and small appliances to home living, audio and smart gadgets, priced up front in USD or NGN.",
};
    ...
    <div className="container-page py-12 lg:py-16">
      <div className="max-w-xl">
        ...
        <p className="mt-4 text-base leading-relaxed text-ink/70">
          Thirty products across kitchen, appliances, home living, audio and
          smart gadgets — each priced up front. Prices convert automatically
