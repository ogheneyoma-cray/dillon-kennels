...
export const metadata: Metadata = {
  ...
  description:
    "Every product Hogposh stocks, from cleansers and serums to moisturizers, sun care and masks, priced up front in USD or NGN.",
};
    ...
    <div className="container-page py-12 lg:py-16">
      <div className="max-w-xl">
        ...
        <p className="mt-4 text-base leading-relaxed text-ink-soft">
          Fifteen products across cleansers, serums, moisturizers, sun care
          and masks — each priced up front. Prices convert automatically
      ...
      <div className="mt-8 flex flex-wrap gap-2.5">
        <a
          ...
          className={`rounded-full px-4 py-2 text-xs font-bold uppercase tracking-wider transition-colors ${
            !activeCategory ? "bg-ink text-ivory" : "bg-sand text-ink-soft hover:text-ink"
          }`}
        >
          All
        </a>
