...
export const metadata: Metadata = {
  ...
  description: `Browse the full ${site.name} collection of bathroom accessories, kitchen tools, storage & organization, home decor and cleaning essentials.`,
};
    ...
    <div className="container-page py-12 lg:py-16">
      <div className="max-w-xl">
        ...
        <p className="mt-4 text-base leading-relaxed text-ink-soft">
          Twenty household essentials. Prices shown convert automatically
          between US Dollars and Naira using the toggle in the header.
        </p>
      </div>
        ...
        <Link
          ...
          className={`border px-4 py-2 text-xs font-bold uppercase tracking-wide transition-colors ${
            !isValidCategory
              ...
              : "border-navy/20 text-ink-soft hover:border-rust hover:text-rust"
          }`}
        >
          All
        </Link>
