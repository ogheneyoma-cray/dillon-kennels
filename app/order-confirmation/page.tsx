...
function ConfirmationContent() {
  ...
  const orderNumber = searchParams.get("order") ?? "SO-000000";

  return (
    <div className="container-page flex flex-col items-center py-20 text-center lg:py-28">
      <div className="flex h-16 w-16 items-center justify-center border-2 border-ink bg-optic text-ink">
        <svg
          width="30"
          height="30"
          viewBox="0 0 24 24"
      ...
      <div className="mt-8 border-2 border-ink bg-white px-8 py-5">
        <p className="text-xs font-bold uppercase tracking-wider text-ink-soft">
          Order Number
        </p>
        <p className="mt-1 font-display text-2xl font-extrabold text-ink">{orderNumber}</p>
      </div>
