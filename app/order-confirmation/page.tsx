...
function ConfirmationContent() {
  ...
  const orderNumber = searchParams.get("order") ?? "ZPD-000000";

  return (
    <div className="container-page flex flex-col items-center py-20 text-center lg:py-28">
      <div className="flex h-16 w-16 items-center justify-center rounded-full bg-sage-pale text-sage-dark">
        <svg
          width="30"
          height="30"
          viewBox="0 0 24 24"
      ...
      <div className="mt-8 rounded-2xl border border-line bg-paper px-8 py-5">
        ...
        <p className="mt-1 font-display text-2xl text-indigo">{orderNumber}</p>
      </div>
