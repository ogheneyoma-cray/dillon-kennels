...
function ConfirmationContent() {
  ...
  const orderNumber = searchParams.get("order") ?? "VG-000000";

  return (
    <div className="container-page flex flex-col items-center py-20 text-center lg:py-28">
      <div className="flex h-16 w-16 items-center justify-center rounded-full bg-acid/15 text-acid">
        <svg
          width="30"
          height="30"
          viewBox="0 0 24 24"
      ...
      <div className="mt-8 border border-bone/10 bg-graphite px-8 py-5">
        <p className="text-xs uppercase tracking-wider text-bone/50">
          Order Number
        </p>
        <p className="mt-1 font-display text-2xl text-acid">{orderNumber}</p>
      </div>
