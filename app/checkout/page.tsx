    ...
    <div className="container-page py-10 lg:py-16">
      ...
      >
        <div className="space-y-8">
          <fieldset className="border-2 border-ink bg-white p-6">
            <legend className="font-display text-xl font-extrabold uppercase text-ink">
              Contact Details
            </legend>
            <p className="mt-2 text-xs text-ink-soft">
              We&apos;ll use this to confirm your booking and schedule the work.
            </p>
          ...
          <fieldset className="border-2 border-ink bg-white p-6">
            <div className="flex items-center justify-between gap-4">
              ...
              <div className="flex items-center gap-2">
                <span className="flex h-8 w-12 items-center justify-center border-2 border-ink bg-white">
        ...
        <aside className="h-fit border-2 border-ink bg-white p-6">
          ...
          <ul className="mt-5 space-y-3 border-b-2 border-ink pb-5">
            {items.map((item) => (
          ...
          <div className="mt-5 flex justify-between font-display text-lg font-extrabold text-ink">
            <span>Total</span>
