...
export default function CheckoutPage() {
  ...
  return (
    <div className="container-page py-10 lg:py-16">
      <p className="eyebrow">Checkout</p>
      <h1 className="section-heading mt-3">Complete Your Purchase</h1>
      ...
      >
        <div className="space-y-8">
          <fieldset className="rounded-2xl border border-line bg-white p-6 shadow-tile">
            <legend className="font-display text-xl font-bold text-ink">
              Account Details
            </legend>
            <p className="mt-2 text-xs text-ink-soft">
              Your download links and license keys will be sent to this email.
            </p>
          ...
          <fieldset className="rounded-2xl border border-line bg-white p-6 shadow-tile">
            <div className="flex items-center justify-between gap-4">
              ...
              <div className="flex items-center gap-2">
                <span className="flex h-8 w-12 items-center justify-center rounded-lg border border-line bg-white">
                ...
                <span className="flex h-8 w-12 items-center justify-center rounded-lg border border-line bg-white text-[11px] font-black italic tracking-tight text-[#1A1F71]">
                  VISA
                </span>
              </div>
            </div>
