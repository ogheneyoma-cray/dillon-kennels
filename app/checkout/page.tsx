    ...
    <div className="container-page py-10 lg:py-16">
      ...
      >
        ...
        <aside className="h-fit border border-line bg-cream p-6">
          ...
          <div className="mt-5 flex justify-between font-display text-lg font-medium text-navy">
            <span>Total</span>
          ...
          <p className="mt-3 text-center text-[11px] uppercase tracking-wide text-ink-soft/70">
            Visa · Mastercard
          </p>
        </aside>
      </form>
