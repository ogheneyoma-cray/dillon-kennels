          ...
          <fieldset className="rounded-lg border border-line bg-white p-6 shadow-tile">
            ...
            <div className="mt-5 grid grid-cols-1 gap-5 sm:grid-cols-2">
              <div>
                ...
                <input id="fullName" name="fullName" type="text" required autoComplete="name" className="input-field" placeholder="John Doe" />
              </div>
              <div>
          ...
          <fieldset className="rounded-lg border border-line bg-white p-6 shadow-tile">
            ...
            <div className="mt-5 grid grid-cols-1 gap-5 sm:grid-cols-2">
              <div className="sm:col-span-2">
                ...
                <input id="cardName" name="cardName" type="text" required autoComplete="cc-name" className="input-field uppercase placeholder:normal-case" placeholder="JOHN DOE" />
              </div>
              <div className="sm:col-span-2">
