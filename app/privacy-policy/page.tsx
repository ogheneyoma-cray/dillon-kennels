...
export const metadata: Metadata = {
  ...
  description: "How zenpulse digital collects, uses, and protects your personal data.",
};
      ...
      <div className="mt-10 max-w-3xl space-y-8 text-ink/80">
        <section>
          ...
          <p className="mt-3 leading-relaxed">
            ...
            number, and order history. Payment card details entered at
            checkout are used solely to process your transaction and are not
            stored on our servers. We also collect limited technical
        ...
        <section>
          ...
          <p className="mt-3 leading-relaxed">
            We use the information you provide to process your order and
            grant access to the courses you purchase, respond to customer
            service inquiries, send order confirmations and access details,
            and, where you&apos;ve opted in, share updates about new courses. We
            do not sell your personal information to third parties under any
            circumstances.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="mt-3 leading-relaxed">
            ...
            browser&apos;s site data for zenpulsedigital.com.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="mt-3 leading-relaxed">
            ...
            payment processors and is never stored on our systems in full.
