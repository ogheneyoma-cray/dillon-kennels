  ...
  return (
    <div className="container-page py-10 lg:py-16">
      ...
      <div className="mt-10 max-w-3xl space-y-8 text-ink-soft">
        <section>
          <h2 className="font-display text-lg font-medium text-navy">Information We Collect</h2>
        ...
        <section>
          <h2 className="font-display text-lg font-medium text-navy">How We Use Your Information</h2>
          <p className="mt-3 leading-relaxed">
        ...
        <section>
          <h2 className="font-display text-lg font-medium text-navy">Cookies &amp; Local Storage</h2>
          <p className="mt-3 leading-relaxed">
            ...
            browser&apos;s site data for venturecollection.com.
          </p>
        </section>

        <section>
          <h2 className="font-display text-lg font-medium text-navy">Sharing With Third Parties</h2>
          <p className="mt-3 leading-relaxed">
        ...
        <section>
          <h2 className="font-display text-lg font-medium text-navy">Your Rights</h2>
          <p className="mt-3 leading-relaxed">
        ...
        <section>
          <h2 className="font-display text-lg font-medium text-navy">Contact Us</h2>
          <p className="mt-3 leading-relaxed">
