...
export const metadata: Metadata = {
  ...
  description: "How Silverpoodles collects, uses, and protects your personal data.",
};
...
const SECTIONS = [
  ...
  },
  {
    ...
    body: "The site uses browser local storage to remember your cart contents and preferred currency between visits. This stays on your device and is never sent to our servers — you can clear it any time by clearing your browser's site data for silverpoodles.com.",
  },
  {
