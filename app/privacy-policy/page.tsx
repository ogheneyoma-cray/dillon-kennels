...
export const metadata: Metadata = {
  ...
  description: "How Richavaid collects, uses, and protects your personal data.",
};

const SECTIONS = [
  {
    heading: "What We Collect",
    body: `When you purchase a product, contact us, or browse the site, we may collect your name, email address, phone number and order history. Card details entered at checkout are used solely to process your payment and are never stored on our servers. We also collect limited technical data, such as browser type and general usage patterns, to help us improve the site.`,
  },
  {
    heading: "How We Use It",
    body: "We use your information to process purchases and deliver download links, respond to support requests, send order confirmations, and, where you have opted in, share updates about new products. We do not sell your personal information to anyone.",
  },
  {
    heading: "Local Storage",
    body: `The site uses browser local storage to remember your cart contents and preferred currency between visits. This stays on your device and is never sent to our servers — you can clear it any time by clearing your browser's site data for ${site.name.toLowerCase()}.com.`,
  },
  {
