...
export const metadata: Metadata = {
  title: `FAQ | ${site.name}`,
  description: "Answers to common questions about Shams Light IT services, scheduling, pricing and refunds.",
};
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        answer:
          "Yes, most services include a round of revisions. Details are listed on each service page, and our team will confirm scope with you before starting.",
      },
    ],
  },
  {
  ...
  return (
    <div className="container-page py-10 lg:py-16">
      ...
      <p className="mt-4 max-w-xl text-ink-soft">
        ...
        <Link href="/contact" className="text-signal underline decoration-sunbeam decoration-2 underline-offset-4">
          contact page
        </Link>{" "}
              ...
              {group.items.map((item) => (
                <details key={item.question} className="group py-5">
                  <summary className="flex cursor-pointer list-none items-center justify-between gap-4 font-display text-lg text-ink marker:content-none">
                    {item.question}
                    <span className="shrink-0 text-xl text-signal transition-transform group-open:rotate-45">
                      +
                    </span>
                  </summary>
