    ...
    return (
      <div className="container-page flex flex-col items-center justify-center py-24 text-center">
        ...
        <p className="mt-4 max-w-sm text-ink-soft">
          ...
          departures board and find what your business needs.
        </p>
              ...
              <div className="flex flex-1 flex-col justify-between">
                <div className="flex justify-between gap-3">
                  <div>
                    <Link
                      href={`/shop/${item.slug}`}
                      className="font-display text-base leading-snug text-ink hover:text-beacon sm:text-lg"
                    >
                      {item.name}
                    </Link>
                ...
                <div className="mt-4 flex items-center justify-between">
                  ...
                  <button
                    ...
                    className="min-h-[44px] px-2 text-sm font-medium text-ink-soft underline underline-offset-4 hover:text-beacon"
                  >
                    Remove
                  </button>
                </div>
