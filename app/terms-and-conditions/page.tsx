...
export const metadata: Metadata = {
  title: "Terms & Conditions | Nudgenic",
  description:
    "The terms and conditions governing use of the Nudgenic website and orders.",
};
      ...
      <div className="mx-auto mt-10 max-w-3xl space-y-8 text-ink/80">
        <section>
          ...
          <p className="mt-3 leading-relaxed">
            By accessing or using the Nudgenic website, you agree to be
        ...
        <section>
          ...
          <p className="mt-3 leading-relaxed">
            ...
            minor variation between the product photo and the item received
        ...
        <section>
          ...
          <p className="mt-3 leading-relaxed">
            ...
            logos, and design, is the property of Nudgenic and may not be
        ...
        <section>
          ...
          <p className="mt-3 leading-relaxed">
            Nudgenic is not liable for any indirect, incidental, or
