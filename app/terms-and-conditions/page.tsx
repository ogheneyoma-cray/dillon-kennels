      ...
      <div className="mt-10 max-w-3xl space-y-8 text-ink/80">
        ...
        <section>
          ...
          <p className="mt-3 leading-relaxed">
            ...
            in Ghanaian Cedis (GHS) for reference using a fixed conversion
            ...
            confirmed. Slight variation in color or finish between the
            product photo and the item received is expected and is not
            considered a defect.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="mt-3 leading-relaxed">
            {site.legalName} is not liable for any indirect, incidental, or
