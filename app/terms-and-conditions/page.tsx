...
export const metadata: Metadata = {
  ...
  description: "The terms and conditions governing use of the Evintat website and orders.",
};
  ...
  return (
    <div className="container-page py-10 lg:py-16">
      ...
      <div className="mt-10 max-w-3xl space-y-8 text-ink-soft">
        <section>
          <h2 className="font-display text-xl italic text-ink">1. Acceptance of Terms</h2>
          <p className="mt-3 leading-relaxed">
            By using the Evintat website you agree to these Terms & Conditions. If you do not agree, please
            do not use our site or place an order with us.
          </p>
        </section>

        <section>
          <h2 className="font-display text-xl italic text-ink">2. Products & Pricing</h2>
          <p className="mt-3 leading-relaxed">
            ...
            this never affects orders already confirmed. Slight variation in color or texture between the
            product photo and the item received may occur and is not considered a defect.
          </p>
        </section>

        <section>
          <h2 className="font-display text-xl italic text-ink">3. Orders & Payment</h2>
          <p className="mt-3 leading-relaxed">
        ...
        <section>
          <h2 className="font-display text-xl italic text-ink">4. Intellectual Property</h2>
          <p className="mt-3 leading-relaxed">
            All content on this site, including product photography, text, logos and design, is the property
            of Evintat and may not be reproduced or used commercially without our written consent.
          </p>
        </section>

        <section>
          <h2 className="font-display text-xl italic text-ink">5. Limitation of Liability</h2>
          <p className="mt-3 leading-relaxed">
            Evintat is not liable for indirect, incidental or consequential damages arising from use of our
            website or products, including delivery delays caused by third-party logistics providers.
          </p>
        </section>

        <section>
          <h2 className="font-display text-xl italic text-ink">6. Governing Law</h2>
          <p className="mt-3 leading-relaxed">
            These Terms are governed by the laws of the Federal Republic of Nigeria, subject to the exclusive
            jurisdiction of the courts of the Federal Capital Territory.
          </p>
        </section>

        <section>
          <h2 className="font-display text-xl italic text-ink">7. Changes to These Terms</h2>
          <p className="mt-3 leading-relaxed">
