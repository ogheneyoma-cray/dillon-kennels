  ...
  return (
    <div className="container-page py-10 lg:py-16">
      ...
      <div className="mt-10 max-w-3xl space-y-8 text-ink/80">
        <section>
          <h2 className="font-display text-lg text-ink">Order Processing</h2>
          <p className="mt-3 leading-relaxed">
            Every order placed with {site.name} is processed from our studio
            at {addressLines.join(", ")}. Orders are processed Monday
        ...
        <section>
          <h2 className="font-display text-lg text-ink">Delivery Areas &amp; Timelines</h2>
          <p className="mt-3 leading-relaxed">
        ...
        <section>
          <h2 className="font-display text-lg text-ink">Shipping Costs</h2>
          <p className="mt-3 leading-relaxed">
        ...
        <section>
          <h2 className="font-display text-lg text-ink">Tracking Your Order</h2>
          <p className="mt-3 leading-relaxed">
        ...
        <section>
          <h2 className="font-display text-lg text-ink">Failed &amp; Delayed Deliveries</h2>
          <p className="mt-3 leading-relaxed">
