...
export const metadata: Metadata = {
  ...
  description: "Delivery timelines, costs, and coverage for Hogposh orders.",
};
      ...
      <div className="mt-10 max-w-3xl space-y-8 text-ink/80">
        <section>
          ...
          <p className="mt-3 leading-relaxed">
            Every order placed with {site.wordmark} is packed and dispatched
            from our warehouse at {site.addressOneLine}. Orders are
            ...
            products ship. You will receive an email confirmation as soon as
        ...
        <section>
          ...
          <p className="mt-3 leading-relaxed">
            ...
            within Abuja typically arrive within 1–3 business days after
            dispatch. Orders to other states are delivered via our
            logistics partners and typically arrive within 3–7 business
            days, depending on the destination&apos;s distance from Abuja and
        ...
        <section>
          ...
          <p className="mt-3 leading-relaxed">
            ...
            address and the number of products in your order. Orders within
            Abuja totalling over $60 qualify for free standard delivery.
            Orders below this threshold, and all orders outside Abuja, will
            show an itemized delivery fee before you confirm payment.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="mt-3 leading-relaxed">
            ...
            collection point. {site.wordmark} is not responsible for delays
