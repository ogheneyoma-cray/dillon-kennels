...
export const metadata: Metadata = {
  ...
  description: "How and when you get access to a Webreid course after purchase.",
};
      ...
      <div className="mt-10 max-w-3xl space-y-8 text-ink/80">
        <section>
          ...
          <p className="mt-3 leading-relaxed">
            ...
            confirmed, your course is unlocked automatically and you&apos;ll
            receive an email with your login details and a direct link to
        ...
        <section>
          ...
          <p className="mt-3 leading-relaxed">
            ...
            confirmation email hasn&apos;t arrived within 30 minutes, check your
            spam folder before contacting {site.email} — access issues are
        ...
        <section>
          ...
          <p className="mt-3 leading-relaxed">
            Every course purchase includes lifetime access — no subscription
            and no expiry date. You can revisit any course as many times as
            you need, on any device, from your course dashboard.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="mt-3 leading-relaxed">
            If you&apos;re locked out of your dashboard or need your access link
            resent, contact us at {site.email} or {site.phone} with your
            order number and we&apos;ll restore access promptly.
          </p>
        </section>
      </div>
    </div>
